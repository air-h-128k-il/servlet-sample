...
public class Login extends HttpServlet {
  public void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    out.println("<br>");
    out.println("<p><a href=\"/link2-1.0/page1\">外来待ち受けページ</a></p>");
    out.println("<p><a href=\"/link2-1.0/page2\">患者検索ページ</a></p>");
    out.println("<p><a href=\"/link2-1.0/page3\">検査オーダーページ</a></p>");
    out.println("<p><a href=\"/link2-1.0/page4\">HorliX Web Viewer</a></p>");
